...
public final class HexViewController {
    ...
    public HexView getHexView() { return hexView; }

    public void registerAnalyzer(DataAnalyzer analyzer) { analyzers.add(analyzer); }
    public List<DataAnalyzer> getAnalyzers() { return analyzers; }
    ...
    public void registerHighlighter(BuiltinHighlighter highlighter) { highlighters.add(highlighter); }
    public List<BuiltinHighlighter> getHighlighters() { return highlighters; }
    ...
    public PatternModel getPatternModel() { return patternModel; }

    private void onHover(long address, int size) {}

    public Color getSelectionColor() { return selectionColor; }
    public Color getMagicColor() { return magicColor; }
    public Color getVersionColor() { return versionColor; }
    public Color getPoolColor() { return poolColor; }
    public Color getAccessColor() { return accessColor; }
    public Color getMethodColor() { return methodColor; }
    public Color getFieldColor() { return fieldColor; }
    public Color getInterfaceColor() { return interfaceColor; }
    public Color getAttributeColor() { return attributeColor; }
    public Color getUnknownColor() { return unknownColor; }
}
