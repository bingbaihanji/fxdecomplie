...
/**
 * int → int 稀疏映射(SparseIntArray)
 *
 * <p>
 * {@code SparseIntArray} 把 int 键映射到 int 值键之间可以有空洞相比用 {@link java.util.HashMap} 存
 * {@code Integer → Integer},它更省内存：既避免了键和值的自动装箱,也不需要为每个映射额外创建 Entry 对象
 *
 * <p>
 ...
 *
 * <p>
 * 本类参考 Android {@code android.util.SparseIntArray} 的设计思想,实现完全基于 Java SE,不依赖 Android
 * 本类不是线程安全的
 *
 * @author bingbaihanji
 * @date 2026-07-10 14:22:20
 * @description int → int  将整数映射为整数
 */
public class SparseIntArray implements Cloneable {
    ...
    /**
     * 创建一个空的 SparseIntArray,并预留可容纳指定数量映射的容量
     *
     * <p>
     ...
     *
     * <p>
     * 若键不大于当前最大键,则退化为 {@link #put(int, int)}
     *
     * @param key 键
     * @param value 值
     */
