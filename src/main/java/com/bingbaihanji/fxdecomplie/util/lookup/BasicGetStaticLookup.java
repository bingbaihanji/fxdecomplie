...
public class BasicGetStaticLookup implements GetStaticLookup {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BasicGetStaticLookup.class);
    ...
    private static String getKey(FieldInsnNode field) {
        return field.owner + "." + field.name;
    }

    @Override
    public ReValue get(FieldInsnNode field) {
    ...
    @Override
    public boolean hasLookup(FieldInsnNode field) {
