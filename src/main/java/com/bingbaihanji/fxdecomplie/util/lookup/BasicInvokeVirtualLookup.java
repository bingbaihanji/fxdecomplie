...
public class BasicInvokeVirtualLookup extends BasicLookupUtils implements InvokeVirtualLookup {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BasicInvokeVirtualLookup.class);
    ...
    private static String getKey(MethodInsnNode method) {
    ...
    @Override
    public ReValue get(MethodInsnNode method, ReValue context, List<? extends ReValue> values) {
    ...
    @Override
    public boolean hasLookup(MethodInsnNode method) {
