...
public class RegisterArg extends InsnArg implements Named {
	...
	/**
	 * 获取当前类型。如果已关联 SSA 变量，则返回 SSA 变量的推断类型；
	...
	/**
	 * 获取不可变类型。如果 SSA 变量存在则委托给 SSA 变量；
	...
	/**
	 * 获取参数名称。优先返回 super/this 关键字名称，否则返回 SSA 变量的名称。
	 *
	...
	/**
	 * 设置参数名称。如果 SSA 变量存在且名称不为 null，则委托给 SSA 变量设置。
	 *
	 * @param name 参数名称
	 */
	@Override
