package com.bingbaihanji.fxdecomplie.core.jadx.core.dex.visitors.usage;

import com.bingbaihanji.fxdecomplie.core.jadx.api.usage.IUsageInfoData;
import com.bingbaihanji.fxdecomplie.core.jadx.api.usage.IUsageInfoVisitor;
import com.bingbaihanji.fxdecomplie.core.jadx.core.clsp.ClspClass;
import com.bingbaihanji.fxdecomplie.core.jadx.core.clsp.ClspClassSource;
...
public class UsageInfo implements IUsageInfoData {
    ...
    public void unresolvedMethodUse(MethodNode mth, MethodInfo useMth) {
        if ("java.lang.Object.<init>()V".equals(useMth.getRawFullId())) {
